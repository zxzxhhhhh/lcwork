...
checkpoints_dir = '/home/zxu/workspace/checkpoints'
...
with tf.Graph().as_default():
    ...
    # Make it like: [batch_size, height, width, channels]
    ...
    with tf.Session() as sess:
        ...
        # from enumerate() get the (index, value) pairs ,
        # sort according to the value and return the index value.
